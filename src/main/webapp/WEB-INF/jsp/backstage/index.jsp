...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li>${adminUser.movieRole.roleName }</li>
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A">${adminUser.auserName } <i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="javascript:;" onclick="admin_show('个人信息','${pageContext.request.contextPath }/admin/adminshow/${adminUser.auserId }','${adminUser.auserId }','340','350')">个人信息</a></li>
						<li><a href="javascript:;" onclick="change_password('修改密码','${pageContext.request.contextPath }/admin/changeAdPassword/${adminUser.auserId }','10001','600','270')">修改密码</a></li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath }/movie/movielist" data-title="电影列表" href="javascript:void(0)">电影列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="picture-list.html" data-title="电影院列表" href="javascript:void(0)">电影院列表</a></li>
					<li><a data-href="picture-list.html" data-title="放映厅管理" href="javascript:void(0)">放映厅管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-product">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a data-href="http://h-ui.duoshuo.com${pageContext.request.contextPath }/admin/" data-title="评论列表" href="javascript:;">评论列表</a></li>
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath }/user/userlist" data-title="会员列表" href="javascript:;">会员列表</a></li>
	...
	<c:if test="${adminUser.movieRole.roleId==1 }">
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a data-href="${pageContext.request.contextPath }/admin/adminlist" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
			</ul>
		</dd>
	</dl>
	</c:if>
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="${pageContext.request.contextPath }/admin/welcome">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${pageContext.request.contextPath }/backstage/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
