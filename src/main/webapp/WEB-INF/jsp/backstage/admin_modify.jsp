...
<article class="page-container">
	...
	<input type="hidden" value="${mau.auserId }" name="auserId">
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>管理员：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${mau.auserName }" placeholder="" id="auserName" name="auserName">
		</div>
	</div>
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9 skin-minimal">
			<c:if test="${mau.auserSex=='男' }">
					<div class="radio-box">
						<input name="auserSex" type="radio" id="sex-1" value="男" checked>
						<label for="sex-1">男</label>
					</div>
					<div class="radio-box">
						<input name="auserSex" type="radio" id="sex-2" value="女">
						<label for="sex-2">女</label>
					</div>
				</c:if>
				<c:if test="${mau.auserSex=='女' }">
					<div class="radio-box">
						<input name="auserSex" type="radio" id="sex-1" value="男">
						<label for="sex-1">男</label>
					</div>
					<div class="radio-box">
						<input name="auserSex" type="radio" id="sex-2" value="女" checked>
						<label for="sex-2">女</label>
					</div>
				</c:if>
		</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${mau.auserPhone}" placeholder="" id="phone" name="auserPhone">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>邮箱：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" placeholder="@" value="${mau.auserEmail }" name="auserEmail" id="email">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">角色：</label>
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="movieRole.roleId" size="1">
				<c:forEach items="${list }" var="li">
					<c:if test="${mau.movieRole.roleName==li.roleName }">
						<option value="${li.roleId }" selected>${li.roleName }</option>
					</c:if>
					<c:if test="${mau.movieRole.roleName!=li.roleName }">
