...
<article class="page-container">
	<form action="${pageContext.request.contextPath }/user/updatePassword/${movieUser.userId }" method="post" class="form form-horizontal" id="form-change-password">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>账户：</label>
			<div class="formControls col-xs-8 col-sm-9"> ${movieUser.userName } </div>
		</div>
		<div class="row cl">
