...
<![endif]-->
<title>新增图片</title>
<link href="${pageContext.request.contextPath }/backstage/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">影片子标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>影片类型：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
				<select name="" class="select">
					<c:forEach items="${type }" var="ty">
					<c:if test="${ty.type.typeName }">
						<option value="${ty.type.typeId }">${ty.type.typeName }</option>
						<c:if>
						<option value="${ty.stId }">├${ty.stName }</option>
					</c:forEach>
				</select>
				</span>
			</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/backstage/lib/webuploader/0.1.5/webuploader.min.js"></script> 
